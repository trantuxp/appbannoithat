...
public class BanAdapter  extends BaseAdapter {
    ...
    public BanAdapter(Context context, ArrayList<Sanpham> arrayListban) {
    ...
    public View getView(int position, View view, ViewGroup parent) {
        ...
        if (view ==null){
            ...
            view = inflater.inflate(R.layout.dong_ban,null); // view = giao dien dòng của listview ,view để vẽ
