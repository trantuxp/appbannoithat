...
public class DanhmucAdapter extends BaseAdapter {
    ...
    public DanhmucAdapter(Context context, ArrayList<Sanpham> arrayListban) {
    ...
    public View getView(int position, View view, ViewGroup parent) {
        ...
        if (view ==null){
            ...
            view = inflater.inflate(R.layout.dong_danhmuc,null); // view = giao dien dòng của listview ,view để vẽ
        ...
        viewHolder.txtban.setText(sanpham.getTenhang());
        DecimalFormat decimalFormat = new DecimalFormat("###,###,###");
        viewHolder.txtgiaban.setText("Giá: "+decimalFormat.format(sanpham.getDongia())+" Đ");
